        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md p-6 bg-white rounded shadow-md">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <button
                        type="submit"
                        className="bg-[#022CDC] text-white py-2 px-4 rounded hover:bg-[#022CDC]/90"
                    >
                        Solicitar acceso
                    </button>
                </form>
                <button
                    onClick={() => navigate("/")}
                    className="mt-4 w-full text-center text-black bg-[#022CDC]/25 py-2 rounded border-none cursor-pointer"
                >
                    Volver al login
                </button>
            </div>
